...
public class consultantaController {
	...
	public void testConsultSave() {
		...
		consult0.setId(3L);
		consult0.setName("Testing Consultant");
		consult0.setEmail("Testing@gmail.com");
		consult0.setNic("NIC");
		consult0.setStart_time("9.00");
		consult0.setEnd_time("10.00");
		consult0.setPassword("Test123");
