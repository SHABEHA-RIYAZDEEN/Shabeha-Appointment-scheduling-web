...
public class AppointmentController {
	...
	public void testAppointmentSave() {
		...
		appoinment.setId(2L);
		appoinment.setC_name("Testing Consultant");
		appoinment.setU_name("Testing User");
		appoinment.setBook_date("19/08/2023");
		appoinment.setTime("8.00");
		appoinment.setContact("077788904");
